...
<TableOfContentsItem topic='step 01 -  connect to a database' label='01 connect to a database'>
...
<TableOfContentsItem topic='step 02 -  create a table in the DB' label='02 create a table in the DB'>
...
<TableOfContentsItem topic='step 07 -  a SQL table for messages' label='07 a SQL table for messages'>
