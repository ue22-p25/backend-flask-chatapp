...
<TableOfContentsItem topic='step 01 -  connect to a database'>
...
<TableOfContentsItem topic='step 01b -  GET /db/alive'>
...
<TableOfContentsItem topic='step 01c -  GET /api/version'>
...
<TableOfContentsItem topic='step 02 -  create a table in the DB'>
...
<TableOfContentsItem topic='step 02b -  POST /api/users to create a user'>
...
<TableOfContentsItem topic='step 03 -  GET /api/users to list users'>
...
<TableOfContentsItem topic='step 04-1/3 GET /front/users'>
...
<TableOfContentsItem topic='step 04-2/3 GET /front/users'>
...
<TableOfContentsItem topic='step 04-3/3 GET /front/users'>
...
<TableOfContentsItem topic='step 05 -  redirect the / route to /front/users'>
...
<TableOfContentsItem topic='step 06 -  GET /api/users/&lt;id&gt; to retrieve a single user'>
...
<TableOfContentsItem topic='step 07 -  a SQL table for messages'>
...
<TableOfContentsItem topic='step 07b -  POST /api/messages to create a message'>
...
<TableOfContentsItem topic='step 08 -  GET /api/messages/'>
...
<TableOfContentsItem topic='step 09 -  GET /api/users/&lt;id&gt;/messages - first draft'>
...
<TableOfContentsItem topic='step 10 -  GET /api/users/&lt;id&gt;/messages: to and from user'>
...
<TableOfContentsItem topic='step 11 -  GET /api/users/&lt;id&gt;/messages: more than just ids'>
...
<TableOfContentsItem topic='step 12-1/2 GET /front/messages/&lt;id&gt; a front for messages'>
...
<TableOfContentsItem topic='step 12-2/2 GET /front/messages/&lt;id&gt; a front for messages'>
...
<TableOfContentsItem topic='step 13-1/3 the messages web page can send messages'>
...
<TableOfContentsItem topic='step 13-2/3 the messages web page can send messages'>
...
<TableOfContentsItem topic='step 13-3/3 the messages web page can send messages'>
...
<TableOfContentsItem topic='step 14-1/2 the messages page displays the new message'>
...
<TableOfContentsItem topic='step 14-2/2 the messages page displays the new message'>
...
<TableOfContentsItem topic='step 15-1/2 messages creation endpoint returns more details'>
...
<TableOfContentsItem topic='step 15-2/2 messages creation endpoint returns more details'>
...
<TableOfContentsItem topic='step 16-1/3 pouring SocketIO into the mix'>
...
<TableOfContentsItem topic='step 16-2/3 pouring SocketIO into the mix'>
...
<TableOfContentsItem topic='step 16-3/3 pouring SocketIO into the mix'>
...
<TableOfContentsItem topic='step 17-1/3 pass current nickname to the JS code'>
...
<TableOfContentsItem topic='step 17-2/3 pass current nickname to the JS code'>
...
<TableOfContentsItem topic='step 17-3/3 pass current nickname to the JS code'>
...
<TableOfContentsItem topic='step 18 -  new messages notified on the socketio channel'>
...
<TableOfContentsItem topic='step 19-1/2 display incoming messages in the frontend'>
...
<TableOfContentsItem topic='step 19-2/2 display incoming messages in the frontend'>
