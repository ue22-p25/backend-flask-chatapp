...
## !!steps 01: connect to a database
...
## !!steps 02: create a table in the DB
...
## !!steps 07: a SQL table for messages
...
## !!steps 14 (1/2): the messages page displays the message it just sent
...
## !!steps 14 (2/2): the messages page displays the message it just sent
