...
<TableOfContentsItem topic='step 01a -  connect to a database' label='01a connect to a database' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 01b -  GET /db/alive' label='01b GET /db/alive' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 01c -  GET /api/version' label='01c GET /api/version' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 02a -  create a table in the DB' label='02a create a table in the DB' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 02b -  POST /api/users to create a user' label='02b POST /api/users to create a user' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 03 -  GET /api/users to list users' label='03 GET /api/users to list users' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 04 - 1/3 GET /front/users' label='04 GET /front/users' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 04 - 2/3 GET /front/users' label='04 - 2/3' tooltip='new file ./static/style.css'>
...
<TableOfContentsItem topic='step 04 - 3/3 GET /front/users' label='04 - 3/3' tooltip='new file ./templates/users.html.j2'>
...
<TableOfContentsItem topic='step 05 -  redirect the / route to /front/users' label='05 redirect the / route to /front/users' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 06 -  GET /api/users/&lt;id&gt; to retrieve a single user' label='06 GET /api/users/&lt;id&gt; to retrieve a single user' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 07a -  a SQL table for messages' label='07a a SQL table for messages' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 07b -  POST /api/messages to create a message' label='07b POST /api/messages to create a message' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 08 -  GET /api/messages/' label='08 GET /api/messages/' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 09 -  GET /api/users/&lt;id&gt;/messages - first draft' label='09 GET /api/users/&lt;id&gt;/messages - first draft' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 10 -  GET /api/users/&lt;id&gt;/messages: to and from user' label='10 GET /api/users/&lt;id&gt;/messages: to and from user' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 11 -  GET /api/users/&lt;id&gt;/messages: more than just ids' label='11 GET /api/users/&lt;id&gt;/messages: more than just ids' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 12 - 1/2 GET /front/messages/&lt;id&gt; a front for messages' label='12 GET /front/messages/&lt;id&gt; a front for messages' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 12 - 2/2 GET /front/messages/&lt;id&gt; a front for messages' label='12 - 2/2' tooltip='new file ./templates/messages.html.j2'>
...
<TableOfContentsItem topic='step 13 - 1/3 the messages web page can send messages' label='13 the messages web page can send messages' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 13 - 2/3 the messages web page can send messages' label='13 - 2/3' tooltip='changes in ./templates/messages.html.j2'>
...
<TableOfContentsItem topic='step 13 - 3/3 the messages web page can send messages' label='13 - 3/3' tooltip='new file ./static/script.js'>
...
<TableOfContentsItem topic='step 14 - 1/2 the messages page displays the new message' label='14 the messages page displays the new message' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 14 - 2/2 the messages page displays the new message' label='14 - 2/2' tooltip='changes in ./static/script.js'>
...
<TableOfContentsItem topic='step 15 - 1/2 messages creation endpoint returns more details' label='15 messages creation endpoint returns more details' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 15 - 2/2 messages creation endpoint returns more details' label='15 - 2/2' tooltip='changes in ./static/script.js'>
...
<TableOfContentsItem topic='step 16 - 1/3 pouring SocketIO into the mix' label='16 pouring SocketIO into the mix' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 16 - 2/3 pouring SocketIO into the mix' label='16 - 2/3' tooltip='changes in ./static/script.js'>
...
<TableOfContentsItem topic='step 16 - 3/3 pouring SocketIO into the mix' label='16 - 3/3' tooltip='changes in ./templates/messages.html.j2'>
...
<TableOfContentsItem topic='step 17 - 1/3 pass current nickname to the JS code' label='17 pass current nickname to the JS code' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 17 - 2/3 pass current nickname to the JS code' label='17 - 2/3' tooltip='changes in ./static/script.js'>
...
<TableOfContentsItem topic='step 17 - 3/3 pass current nickname to the JS code' label='17 - 3/3' tooltip='changes in ./templates/messages.html.j2'>
...
<TableOfContentsItem topic='step 18 -  new messages notified on the socketio channel' label='18 new messages notified on the socketio channel' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 19 - 1/2 display incoming messages in the frontend' label='19 display incoming messages in the frontend' tooltip='changes in ./app.py'>
...
<TableOfContentsItem topic='step 19 - 2/2 display incoming messages in the frontend' label='19 - 2/2' tooltip='changes in ./static/script.js'>
